...
export function CategoryDropDown({ loggedInUser }) {
  return (
    <Menu as="div" className="  lg:hidden relative inline-block text-left  ">
      ...
      >
        <Menu.Items className="absolute -right-5 z-10 mt-2 w-40 origin-top-left rounded-md bg-white dark:bg-zinc-800 shadow-md ring-1 ring-black ring-opacity-5 focus:outline-none">
          <div className="py-1">
            <Menu.Item>
              {({ active }) => (
                <Link
