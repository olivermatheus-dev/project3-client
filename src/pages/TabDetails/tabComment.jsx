    ...
    <>
      <div>
        <div className="py-20 flex items-center justify-center">
          <div className="-mt-20 w-5/6 sm:w-4/6   sm:h-6/6 mx-auto overflow-hidden bg-white rounded-lg shadow-md dark:bg-zinc-800">
                  ...
                  <div className="flex gap-5">
                    <div className="w-full">
                      <input
                        ...
                        className="block  rounded-l-lg w-full sm:w-[500px] px-4 py-2 mt-2 h-12 text-gray-700 dark:text-gray-200 placeholder-gray-500 bg-white border dark:bg-zinc-700 dark:border-gray-600 dark:placeholder-gray-400  focus:outline-none focus:ring-0"
                      />
                    </div>
                  </div>
