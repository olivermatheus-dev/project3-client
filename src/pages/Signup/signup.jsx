          ...
          <form onSubmit={handleSubmit}>
            ...
            <div>
              <label
                ...
                // class="flex flex-col items-center w-full max-w-lg p-5 mx-auto mt-2 text-center bg-white border-2 border-gray-300 border-dashed cursor-pointer dark:bg-zinc-800 dark:border-gray-700 rounded-xl "
              >
                <svg
